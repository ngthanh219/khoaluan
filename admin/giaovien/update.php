<?php
    ...
    $editGiaovien = $db->fetchOne("tbl_giaovien",(int)$id);
    //    dd($editGiaovien);
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        {
            if ($sodienthoai != $editGiaovien['sodienthoai'])
            {
    ...
    //            dd($data);
            // insert
            $update = $db->update("tbl_giaovien",$data,"id = ".$id);
            if($update)
            {
                            ...
                            <form class="form-horizontal" role="form" method="POST" action="" enctype="multipart/form-data">
                                <div class="form-body" id="info">
                                        ...
                                        <div class="col-md-9">
                                            <select name="id_makhoa" class="form-control makhoa">
                                                ...
                                                <?php foreach($khoa as $item) : ?>
                                                    <option value="<?php echo $item['makhoa'] ?>" <?php echo isset($editGiaovien['id_makhoa']) && $editGiaovien['id_makhoa'] == $item['makhoa'] ? "selected='selected'" : "" ?>><?php echo $item['tenkhoa'] ?></option>
                                                <?php endforeach ; ?>
                                            </select>
                                        ...
                                        <div class="col-md-9">
                                            <select name="id_machuyennganh" class="form-control chuyennganh">
                                                ...
                                                <?php foreach($chuyennganh as $item) : ?>
                                                    <option value="<?php echo $item['machuyennganh'] ?>" <?php echo isset($editGiaovien['id_machuyennganh']) && $editGiaovien['id_machuyennganh'] == $item['machuyennganh'] ? "selected='selected'" : "" ?>><?php echo $item['tenchuyennganh'] ?></option>
                                                <?php endforeach ; ?>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control inputForm" name="tengiaovien" value="<?php echo isset($editGiaovien['tengiaovien']) ? $editGiaovien['tengiaovien'] : '' ?>" placeholder=" VD : Nguyễn Văn A ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="date" class="form-control input-inline input-medium" value="<?php echo $editGiaovien['ngaysinh'] ?>"  name="ngaysinh" placeholder="12-12-2012"  >
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" value="<?php echo isset($editGiaovien) ? $editGiaovien['trangthai'] : '' ?>"  name="trangthai" placeholder=" Đơn vị công tác"  >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control inputForm" name="email" value="<?php echo isset($editGiaovien['email']) ? $editGiaovien['email'] : '' ?>" placeholder=" VD : admin@gmail.com ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control inputForm" name="quequan" value="<?php echo isset($editGiaovien['quequan']) ? $editGiaovien['quequan'] : '' ?>" placeholder=" VD : Quỳnh lưu - Nghệ An  ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input type="number" class="form-control" name="sodienthoai" value="<?php echo isset($editGiaovien['sodienthoai']) ? $editGiaovien['sodienthoai'] : '' ?>" >
                                    ...
                                    <div class="form-group" id="image" style="border: 1px solid #dedede;padding: 20px;margin: 20px">
                                        ...
                                        <?php if($editGiaovien['hinhanh'] != '') : ?>
                                            <img id='img-upload' src="<?php echo base_url('/public/uploads/images/') ?><?php echo $editGiaovien['hinhanh'] ?>" alt="" class="img img-responsive" style="width: 300px;height: 300px;"/>
                                        <?php endif ; ?>
                                    ...
                                    <div class="form-group" id="desc">
                                        ...
                                        <div class="col-sm-11" style="padding-left:30px">
                                            <textarea name="gioithieu" id="summernote" cols="130"  rows="10"><?php echo isset($editGiaovien['gioithieu']) ? $editGiaovien['gioithieu'] : '' ?></textarea>
