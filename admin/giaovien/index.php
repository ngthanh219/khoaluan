<?php
    ...
    $sql = " SELECT tbl_giaovien.* , tbl_chuyennganh.tenchuyennganh as tenchuyennganh , tbl_khoa.tenkhoa as tenkhoa FROM tbl_giaovien 
        LEFT JOIN tbl_chuyennganh ON tbl_chuyennganh.machuyennganh = tbl_giaovien.id_machuyennganh
        LEFT JOIN tbl_khoa ON tbl_khoa.makhoa = tbl_giaovien.id_makhoa
         WHERE 1
    ";
    ...
    $Giaovien = $pagi->pagination("tbl_giaovien",$sql,'page',4);
?>
                            ...
                            <table class="table table-bordered table-striped table-condensed">
                                ...
                                <?php foreach($Giaovien as $item) :?>
                                    <tr>
                                        ...
                                        <td>
                                            <span><?php echo $item['tengiaovien'] ?></span>
                                        </td>
                                        <td class="">
                                            <ul>
                                                <li> <span class="fa fa-phone"></span><?php echo $item['sodienthoai'] ?></li>
                                                <li> <span class=" fa fa-envelope"></span> <?php echo $item['email'] ?> </li>
                                                <li> <span class=" fa fa-map-marker"></span> <?php echo $item['quequan'] ?> </li>
                                                <?php echo $item['trangthai'] !=  '' ?   $item['trangthai'] : '' ?>
                                                <li> Ngày sinh : <?php echo $item['ngaysinh'] ?></li>
                                                <li>
