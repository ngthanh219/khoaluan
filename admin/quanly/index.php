<?php
    $modules = 'quanly';
    $title = " Danh sách quan ly ";
    require_once __DIR__.'/../autoload.php';

    // lay danh sach khoa
    $quanly = $pagi->pagination("tbl_quanly",'','page',4);
                            ...
                            <table class="table table-bordered table-striped table-condensed table-hover">
                                ...
                                <?php  foreach($quanly as $item) :?>
                                    <tr>
                                        ...
                                        <td>
                                            <span> <?php echo $item['tenquanly'] ?> </span>
                                        </td>
                                        <td><?php echo $item['email'] ?></td>
                                        
                                        <td class="">
                                            <a href="delete.php?id=<?php echo $item['id'] ?>" class="btn btn-xs red" onclick="return showAlert()"><i class="fa fa-trash-o"></i></a>
                                            <a href="edit.php?id=<?php echo $item['id'] ?>" class="btn btn-xs green"><i class="fa fa-pencil"></i></a>
                                        </td>
