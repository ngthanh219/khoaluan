...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if ($ngaysinh == '')
    {
        $errors['ngaysinh']  = ' Mời bạn nhập ngày sinh  ' ;
    }
    ...
    {
        if ($masinhvien != $editSinhvien['masinhvien'])
        {
    ...
    {
        if ($sodienthoai != $editSinhvien['sodienthoai'])
        {
    ...
    if (  empty($errors))
    {
        ...
        if($update)
        {
            ...
            if($id_malop != $editSinhvien['id_malop'])
            {
                $db->update("tbl_lop","siso = siso + 1"," malop = '".$id_malop."' ");
                $db->update("tbl_lop","siso = siso - 1"," malop = '".$editSinhvien['id_malop']."' ");
            }
                            ...
                            <form class="form-horizontal" role="form" method="POST" action="" enctype="multipart/form-data">
                                <div class="form-body" id="info">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control inputForm" name="tensinhvien" value="<?php echo isset($editSinhvien)  ? $editSinhvien['tensinhvien'] : ''?>" placeholder=" VD : Nguyễn Văn A ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control input-inline input-medium"  name="masinhvien" placeholder="MSP01212" value="<?php echo isset($editSinhvien)  ? $editSinhvien['masinhvien'] : ''?>" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="date" class="form-control input-inline input-medium" value="<?php echo $editSinhvien['ngaysinh'] ?>"  name="ngaysinh" placeholder="12-12-2012"  >
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label"> Mat khau  </label>
                                        <div class="col-md-9">
                                            <input type="password" class="form-control input-inline input-medium" value="<?php echo $editSinhvien['matkhau'] ?>"  name="matkhau" placeholder="******"  >
                                        ...
                                        <div class="col-md-9">
                                            <select name="id_makhoa" class="form-control makhoa">
                                                ...
                                                <?php foreach($khoa as $item) : ?>
                                                    <option value="<?php echo $item['makhoa'] ?>" <?php echo isset($editSinhvien) && $editSinhvien['id_makhoa'] == $item['makhoa'] ? "selected='selected'" : "" ?>><?php echo $item['tenkhoa'] ?></option>
                                                <?php endforeach ; ?>
                                            </select>
                                        ...
                                        <div class="col-md-9">
                                            <select name="id_machuyennganh" class="form-control chuyennganh">
                                                ...
                                                <?php foreach($chuyennganh as $item) : ?>
                                                    <option value="<?php echo $item['machuyennganh'] ?>" <?php echo isset($editSinhvien) && $editSinhvien['id_machuyennganh'] == $item['machuyennganh'] ? "selected='selected'" : "" ?>><?php echo $item['tenchuyennganh'] ?></option>
                                                <?php endforeach ; ?>
                                            </select>
                                        ...
                                        <div class="col-md-4">
                                            <select name="id_malop" class="form-control lop">
                                                ...
                                                <?php foreach($lop as $item) : ?>
                                                    <option value="<?php echo $item['malop'] ?>" <?php echo isset($editSinhvien) && $editSinhvien['id_malop'] == $item['malop'] ? "selected='selected'" : "" ?>><?php echo $item['tenlop'] ?></option>
                                                <?php endforeach ; ?>
                                            </select>
                                        ...
                                        <div class="col-md-3">
                                            <select name="id_mahedaotao" class="form-control">
                                                ...
                                                <?php foreach($hedaotao as $item) : ?>
                                                    <option value="<?php echo $item['mahedaotao'] ?>" <?php echo isset($editSinhvien) && $editSinhvien['id_mahedaotao'] == $item['mahedaotao'] ? "selected='selected'" : "" ?>><?php echo $item['tenhedaotao'] ?></option>
                                                <?php endforeach ; ?>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control inputForm" name="email" placeholder=" VD : admin@gmail.com " value="<?php echo isset($editSinhvien)  ? $editSinhvien['email'] : ''?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control inputForm" name="quequan" placeholder=" VD : Quỳnh lưu - Nghệ An  " value="<?php echo isset($editSinhvien)  ? $editSinhvien['quequan'] : ''?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" class="form-control" name="sodienthoai" value="<?php echo isset($editSinhvien)  ? $editSinhvien['sodienthoai'] : ''?>">
