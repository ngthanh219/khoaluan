<?php
    ...
    $dot = $pagi->pagination("tbl_dot", "Select * from tbl_dot order by id desc", "page", 15);
?>
                        ...
                        <div class="portlet-body flip-scroll">
                            <table class="table table-bordered table-striped table-condensed">
                                ...
                                <tr>
                                    ...
                                    <th width="">Đợt</th>
                                    <th width="">Thời gian bắt đầu</th>
                                    <th width="">Thời gian kết thúc</th>
                                ...
                                <?php foreach($dot as $item) :?>
                                    <tr>
                                        ...
                                        <td><span> <?php echo $item['dot'] ?> </span></td>
                                        <td><span> <?php echo $item['batdau'] ?> </span></td>
                                        <td><span> <?php echo $item['ketthuc'] ?> </span></td>
