                    ...
                    <form class="form-inline" action="" method="POST" style="margin-top:10px">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" name="id_giaovien">
                                 <option value=""> -- Chọn giảng viên HD -- </option>
                                    ...
                                    <tbody>
                                        <?php foreach ($doan as $item): ?>
                                            <tr>
                                                ...
                                                <td>
                                                     <?php if( ! isset($_SESSION['user_id'])) :?>
                                                    <a href="update.php?id=<?php echo $item['id'] ?>"> <span  class="label label-success "><i class="fa fa-pencil"></i></span> </a>
                                                    <a href="delete.php?id=<?php echo $item['id'] ?>" onclick="return showAlert()" > <span class="label label-danger"><i class="fa fa-trash-o"></i></span>   </a>
                                                <?php endif; ?>
