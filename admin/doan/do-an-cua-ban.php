<?php
    $modules = "do-an-cua-ban";
    $title = " Danh sách đồ án của bạn  " ;
    require_once __DIR__.'/../autoload.php';
    
    $user = $db->query("tbl_giaovien", "*", " AND id = " . $_SESSION["admin_id"])[0];
    ...
    $sql = "SELECT tbl_doan.*, tbl_sinhvien.tensinhvien as tensinhvien,tbl_lop.tenlop as tenlop , tbl_hoidong.tenhoidong as tenhoidong,
        ...
        WHERE 1 AND tbl_doan.id_giaovien = '" . $user["id"] . "' ORDER BY  ID DESC
    ";
                                    ...
                                    <table class="table table-condensed table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                     <?php if( ! isset($_SESSION['user_id'])) :?>
                                                        <a href="confirm.php?id=<?php echo $item['id'] ?>"> <span  class="label label-success "><i class="fa fa-pencil"></i></span> </a>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                            <?php endforeach ?>
