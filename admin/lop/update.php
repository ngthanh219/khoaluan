<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        {
            if ($tenlop != $editLop['tenlop'])
            {
                // kiểm tra xem mã khoa đã tồn tại chưa
                // nếu có thì show lỗi
                $checkEsist = $db->fetchOne("tbl_lop","tenlop = '".$tenlop."' ");
                if ($checkEsist  && count($checkEsist) > 0)
                {
                    $errors['tenlop']  = ' Tên lớp  đã tồn tại ' ;
                }
            }
        ...
        if (  empty($errors))
        {
            ...
            // insert
            $update = $db->update("tbl_lop",$data,'id = '.$id);
            if($update)
            {
                            ...
                            <form class="form-horizontal" role="form" action="" method="POST">
                                <div class="form-body">
                                        ...
                                        <div class="col-md-9">
                                            <select name="id_makhoa" class="form-control makhoa">
                                                ...
                                                <?php foreach($khoa as $item) : ?>
                                                    <option value="<?php echo $item['makhoa'] ?>" <?php echo isset($editLop) && $editLop['id_makhoa'] == $item['makhoa'] ? "selected='selected'" : "" ?>><?php echo $item['tenkhoa'] ?></option>
                                                <?php endforeach ; ?>
                                            </select>
                                        ...
                                        <div class="col-md-9">
                                            <select name="id_machuyennganh" class="form-control chuyennganh">
                                                ...
                                                <?php foreach($chuyennganh as $item) : ?>
                                                    <option value="<?php echo $item['machuyennganh'] ?>" <?php echo isset($editLop) && $editLop['id_machuyennganh'] == $item['machuyennganh'] ? "selected='selected'" : "" ?>><?php echo $item['tenchuyennganh'] ?></option>
                                                <?php endforeach ; ?>
                                            </select>
                                        ...
                                        <div class="col-md-9">
                                            <select name="id_mahedaotao" class="form-control">
                                                ...
                                                <?php foreach($hedaotao as $item) : ?>
                                                    <option value="<?php echo $item['mahedaotao'] ?>" <?php echo isset($editLop) && $editLop['id_mahedaotao'] == $item['mahedaotao'] ? "selected='selected'" : '1' ?>><?php echo $item['tenhedaotao'] ?></option>
                                                <?php endforeach ; ?>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="tenlop" placeholder=" VD :  Mạng máy tính " value="<?php echo isset($editLop) ? $editLop['tenlop'] : ''  ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control input-inline" name="malop" placeholder="MSP01212" value="<?php echo isset($editLop) ? $editLop['tenlop'] : '' ?>">
                                            <?php if (isset($errors['malop']) && $errors['malop'] != '') :?>
                                                <span class="help-block" style="margin-bottom: -10px"><?php echo $errors['malop'] ?></span>
                                            <?php endif; ?>
                                        </div>

                                        <label class="col-md-2 control-label"> Niêm khóa  <span class="text-danger">(*)</span> </label>
                                        <div class="col-md-4">
                                            <select name="id_nienkhoa" class="form-control">
                                                <option value=""> --  Mời bạn chọn nienkhoa! -- </option>
                                                <?php foreach($nkhoa as $item) : ?>
                                                    <option value="<?php echo $item['id'] ?>" <?php echo isset($editLop) && $editLop['id_nienkhoa'] == $item['id'] ? "selected='selected'" : '1' ?>><?php echo $item['tenkhoa'] ?></option>
                                                <?php endforeach ; ?>
                                            </select>
