<?php
    ...
    $edit = $db->fetchOne("tbl_hoidong",(int)$id);
    //    dd($edit);
    if (count($edit) == 0)
    {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        {
            if ($tenhoidong != $edit['tenhoidong'])
            {
                // kiểm tra xem email  đã tồn tại chưa
                // nếu có thì show lỗi
                $checkEsist = $db->fetchOne("tbl_hoidong","tenhoidong = '".$tenhoidong."' ");
                if ($checkEsist  && count($checkEsist) > 0)
                {
                    $errors['tenhoidong']  = ' ten hoi dong đã tồn tại ' ;
                }
            }
        }
...
//            dd($data);
            // insert
            $insert = $db->update("tbl_hoidong",$data," id = ".$id);
            if($insert > 0)
            {
            ...
            {
                $_SESSION['errors'] = " Dữ liệu không thay đổi ";
                redirect('/admin/hoidong');
            }
        }
    }
                            ...
                            <form class="form-horizontal" role="form" method="POST" action="" enctype="multipart/form-data">
                                <div class="form-body" id="info">
                                  <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control inputForm" name="tenhoidong" value="<?php echo isset($edit) ? $edit['tenhoidong'] : '' ?>" placeholder=" VD : Hội đồng 1 ">
                                        ...
                                        <div class="col-md-9">
                                            <select name="id_chutich" class="form-control makhoa">
                                                ...
                                                <?php foreach($giaovien as $item) : ?>
                                                    <option value="<?php echo $item['id'] ?>" <?php echo isset($edit) && $edit['id_chutich'] == $item['id'] ? "selected='selected'" : "" ?>><?php echo $item['tengiaovien'] ?></option>
                                                <?php endforeach ; ?>
                                            </select>
                                    ...
                                    <div class="form-group" id="info">
                                        ...
                                        <div class="col-md-9">
                                            <select name="id_thuky" class="form-control">
                                                ...
                                                <?php foreach($giaovien as $item) : ?>
                                                    <option value="<?php echo $item['id'] ?>" <?php echo isset($edit) && $edit['id_thuky'] == $item['id'] ? "selected='selected'" : "" ?>><?php echo $item['tengiaovien'] ?></option>
                                                <?php endforeach ; ?>
                                            </select>
                                     ...
                                     <div class="form-group" id="info">
                                        ...
                                        <div class="col-md-9">
                                            <select name="id_phanbien" class="form-control">
                                                ...
                                                <?php foreach($giaovien as $item) : ?>
                                                    <option value="<?php echo $item['id'] ?>" <?php echo isset($edit) && $edit['id_phanbien'] == $item['id'] ? "selected='selected'" : "" ?>><?php echo $item['tengiaovien'] ?></option>
                                                <?php endforeach ; ?>
                                            </select>
                                     ...
                                     <div class="form-group" id="info">
                                        ...
                                        <div class="col-md-9">
                                            <select name="id_uyvien" class="form-control">
                                                ...
                                                <?php foreach($giaovien as $item) : ?>
                                                    <option value="<?php echo $item['id'] ?>" <?php echo isset($edit) && $edit['id_uyvien'] == $item['id'] ? "selected='selected'" : "" ?>><?php echo $item['tengiaovien'] ?></option>
                                                <?php endforeach ; ?>
                                            </select>
