...
(11, 'quản lí học sinh', 'qlhsthpt', 'mkcntt', 'HTTT', '64DCTH03', '64DCTH3423', 32, NULL, NULL, 8, 'https://drive.google.com/drive/folders/1R9GJnN6ZsJuzCtgsvOEvlBtTf42VKtJE', 'QL ĐỒ ÁN- Lê thị phương my.doc', 'admin.png', 0, 0, '<p>adsaadfdf</p>', 0, NULL),
(12, 'Do An A', 'm200001', 'mkcntt', 'HTTT', '64DCTH01', '64DCTH2344', 12, NULL, NULL, 20, 'link', 'fix-lỗi.docx', 'logo_laravel.png', 0, 0, '<p>ok</p>', 0, NULL),
(13, 'Do an Nguyen Minh Hoang', 'DA001', 'mkcntt', 'HTTT', '64DCTH01', '64DCTH2344', 15, NULL, NULL, 9, 'link demo', 'fix-lỗi.docx', 'logo_laravel.png', 0, 0, '<p>ok</p>', 0, NULL),
...
--
-- Table structure for table `tbl_dot`
--

CREATE TABLE `tbl_dot` (
  `id` int(11) NOT NULL,
  `dot` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `batdau` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `ketthuc` varchar(255) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `tbl_dot`
--

INSERT INTO `tbl_dot` (`id`, `dot`, `batdau`, `ketthuc`) VALUES
(3, '3', '2022-05-13', '2022-05-14'),
(4, '2', '2022-05-13', '2022-05-14');
...
--
-- AUTO_INCREMENT for table `tbl_dot`
--
ALTER TABLE `tbl_dot`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
